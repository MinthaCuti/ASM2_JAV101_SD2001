...
<head>
    <meta charset="UTF-8">
    <title>Verdelle Hotel - Thêm Phòng Mới</title>
...
<div class="container">
    <div class="form-card">
        <h2><i class="fa-solid fa-plus-circle"></i> Thêm Cấu Hình Phòng Mới</h2>

        <form action="quan-ly-phong?action=create" method="POST">
            <input type="hidden" name="hotelId" value="${sessionScope.currentHotelId != null ? sessionScope.currentHotelId : 1}">

            <div class="form-group">
                <label>Loại phòng (Room Type)</label>
                <input type="text" name="roomTypeName" class="form-control" placeholder="VD: Deluxe Suite, Phòng Đơn..." required>
            </div>

            <div class="form-group mb-3">
                <label class="form-label">Tên phòng / Số phòng</label>
                <input type="text" name="roomNumber" class="form-control" placeholder="Ví dụ: P101, P202" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="maxPeople" class="form-control" min="1" value="2" required>
            </div>

            <div class="form-group">
                <label>Trạng thái phòng đầu kỳ</label>
                <select name="status" class="form-control">
                    <option value="Available">Sẵn sàng đón khách</option>
                    <option value="Unavailable">Đang bảo trì 🛠️</option>
                </select>
            </div>
            ...
            <div class="btn-group">
                ...
                <button type="submit" class="btn btn-submit">
                    <i class="fa-solid fa-plus"></i> Tạo cấu hình
                </button>
            </div>
        </form>
    </div>
