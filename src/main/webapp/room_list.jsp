...
<div class="top-filter-wrapper">
  <form action="SearchController" method="GET" id="searchFilterForm" class="filter-form-mini">
    ...
    <div class="mini-input-box">
      ...
      <input type="text" name="guestsRooms" value="${not empty param.guestsRooms ? param.guestsRooms : '1 Phòng - 1 Người lớn'}">
    </div>
...
<div class="main-content-container">
  ...
  <div class="hotel-header-info">
    ...
    <div class="hotel-address-row">
      <span><i class="fa-solid fa-location-dot" style="color: #00bcd4;"></i> <span id="hotelAddressFull">Địa chỉ: ${not empty selectedHotel.address ? selectedHotel.address : 'Đang cập nhật...'}</span></span>
      ...
      <div class="details-right-sidebar">
        <div class="rating-summary-card">
          ...
          <div class="rating-lines-placeholder">
            <div class="line-p" style="width: 95%;"></div><div class="line-p" style="width: 88%;"></div><div class="line-p" style="width: 90%;"></div>
          </div>
          ...
          <div class="poi-list-advanced" id="poiDynamicContainer">
            <div class="poi-card-item">
              ...
              <div class="poi-info">
                ...
                <p class="poi-address-text">Cách 200 m</p>
              </div>
            </div>
          </div>
  ...
  <div id="cosovatchat" class="tab-content-pane">
    <div class="info-card-block"><h3>Chi tiết dịch vụ tiện ích</h3><p>Nội dung chi tiết về các trang thiết bị và gói tiện ích mở rộng đang được cập nhật...</p></div>
  </div>
  <div id="danhgia" class="tab-content-pane">
    <div class="info-card-block"><h3>Phản hồi từ khách hàng</h3><p>Tính năng đang trong quá trình phát triển. Vui lòng quay lại sau.</p></div>
  </div>
  ...
  <c:choose>
    <c:when test="${empty rooms}">
      <div style="background: var(--card-bg); padding: 40px; text-align: center; border-radius: 8px;">
        <p style="font-weight: bold; color: var(--text-color);">Rất tiếc, hiện tại khách sạn đã kín phòng cho ngày bạn chọn.</p>
        <p style="font-size: 0.9rem; color: var(--sub-text);">Vui lòng thử tìm kiếm với một ngày khác.</p>
      </div>
    </c:when>
    <c:otherwise>
      <%-- ĐỔ DỮ LIỆU ĐỘNG TỪ DATABASE --%>
      <c:forEach var="r" items="${rooms}">
        <div class="room-card">
          <div class="room-card-img">
            <img src="${r.image}" alt="Room Photo">
          </div>
          ...
          <div class="room-card-price-action">
            ...
            <form action="${pageContext.request.contextPath}/BookingController" method="POST" style="width: 100%;">
              ...
              <button type="submit" class="btn-book-room">Đặt phòng ngay</button>
            </form>
          </div>
        </div>
      </c:forEach>
